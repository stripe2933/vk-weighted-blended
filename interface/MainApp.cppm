...
export module vk_weighted_blended:MainApp;
...
namespace vk_weighted_blended {
    ...
    private:
        GLFWwindow *window = glfwCreateWindow(640, 480, "Vulkan Weighted Blended OIT", nullptr, nullptr);
