export module vk_weighted_blended:vulkan.rp.WeightedBlended;
...
namespace vk_weighted_blended::vulkan::rp {
    export struct WeightedBlended final : vk::raii::RenderPass {
        explicit WeightedBlended(
